...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="flex w-full min-h-screen">
        ...
        <main class="flex-1 overflow-y-auto px-8 py-6">
            <!-- Page Content keep away from sidebr -->
                    ...
                    <div class="bg-white card rounded-xl shadow-sm p-6 border border-gray-100">
                        ...
                        <div class="flex items-end justify-between">
                            <div>
                                ...
                                <p
                                    class="text-sm {{ $membersDiff > 0 ? 'text-green-500' : ($membersDiff < 0 ? 'text-red-500' : 'text-gray-500') }} mt-1">
                                    @if ($membersDiff > 0)
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    ...
                                    @endphp
                                    <div class="bg-orange-500 h-2 rounded-full" style="width: {{ $activityWidth }}%">
                                    </div>
                                </div>
                            </div>
                        </div>
